...
class NotificationRestrictionSettingValue {
  const NotificationRestrictionSettingValue(this.value);

  final String value;

  static const NotificationRestrictionSettingValue DISABLED =
      NotificationRestrictionSettingValue('DISABLED');

  static const NotificationRestrictionSettingValue ENABLED =
      NotificationRestrictionSettingValue('ENABLED');

  @override
  int get hashCode => value.hashCode;
  @override
  bool operator ==(Object o) =>
      o is NotificationRestrictionSettingValue && o.value == value;
}
...
class SponsorableOrder {
  ...
  set direction(OrderDirection value) => input['direction'] = value.value;
  set field(SponsorableOrderField value) => input['field'] = value.value;
}

class SponsorableOrderField {
  const SponsorableOrderField(this.value);

  final String value;

  static const SponsorableOrderField LOGIN = SponsorableOrderField('LOGIN');

  @override
  int get hashCode => value.hashCode;
  @override
  bool operator ==(Object o) => o is SponsorableOrderField && o.value == value;
}
...
class UpdateNotificationRestrictionSettingInput {
  ...
  set clientMutationId(String value) => input['clientMutationId'] = value;
  set ownerId(String value) => input['ownerId'] = value;
  set settingValue(NotificationRestrictionSettingValue value) =>
      input['settingValue'] = value.value;
}

...
import 'package:gitgo/src/outbound/api/assigned_issues.data.gql.dart';
import 'package:gitgo/src/outbound/api/assigned_issues.req.gql.dart';
import 'package:gitgo/src/outbound/api/pull_request.data.gql.dart';
import 'package:gitgo/src/outbound/api/pull_request.req.gql.dart';
import 'package:gitgo/src/outbound/api/repository.data.gql.dart';
import 'package:gitgo/src/outbound/api/repository.req.gql.dart';
